...
if (isset ( $_SESSION ['admin_id'] )) {
	$module_constant = 'MIN_MAX_ORDER'; // This should be a UNIQUE name followed by _VERSION for convention
	...
	$module_name = 'Min Max Order by Destination Country'; // This should be a plain English or Other in a user friendly way
	$admin_page = 'min_max_order';
	$module_file_for_version_check = 'min_max_order.php'; // File to check for new version so it doesn't check on every page
